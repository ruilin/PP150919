package com.sunnyday.view.common;
...
public class RefreshViewLayout extends LinearLayout implements OnTouchListener {
	...
	/** 下拉头部回滚的速度	 */
	public static final short SCROLL_SPEED = -20;
	private static final short FRAME_TIME = 10;
	 ...
	 * 下拉刷新的回调接口
	 */
	private PullToRefreshListener mListener = null;
	/**
	 * 用于存储上次更新时间
	 */
		...
		if (ableToPull) {
			...
			case MotionEvent.ACTION_MOVE:
				...
				if (currentStatus != STATUS_REFRESHING) {
					...
					headerLayoutParams.topMargin = (distance >> 1)
							+ hideHeaderHeight;
...
//	}
	...
	/**
	 * 往下：正在刷新的任务，在此任务中会去回调注册进来的下拉刷新监听器。
	 */
	...
	/**
	 * 往上：隐藏下拉头的任务，当未进行下拉刷新或下拉刷新完成后，此任务将会使下拉头重新隐藏。
	 */
